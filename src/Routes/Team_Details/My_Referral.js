...
const My_Referral = () => {
    ...
    const referral_API = async () => {
        try {
            ...
            let responceRight = await API?.post('/directDetails', {
                "id": uId,
                "position": 2,
                "status": status
            })
            ...
            console.log("responseLeftCheck", responseLeft);
            // let arr = []
            let arrayLeft = []
            let arrayRight = []
            ...
            console.log("arrayLeftCheck",arrayLeft);
    ...
    return (
        ...
        <div className="row justify-content-center col-md-11">
            ...
            <div className="col-md-6 py-3 mt-5">
                ...
                <br/>
                    ...
                    <div className="row">
                        ...
                        <select className=" input bg-color asp ps-4 " id="input-select"
                            defaultValue={FilterRight} value={FilterRight}
            ...
            <div className="col-md-6 py-3 mt-5" >
            <div className="col-md-12" id="referral-tool">
                ...
                <div className="col-md-3">
                    ...
                    <div className="col-md-5">
                        <select className=" input bg-color asp ps-4" id="input-select "
                            defaultValue={filterValue} value={filterValue}
