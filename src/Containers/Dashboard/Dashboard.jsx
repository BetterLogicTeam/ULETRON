...
const Dashboard = () => {
  ...
  return (
    <div
      className="Dashboard row m-0 justify-content-center pt-5 "
      style={{
        backgroundImage:
          "linear-gradient(to right top, #2b3f5e, #135f83, #00829e, #00a5ad, #0fc7ad);",
      }}
    >
      <div className=" row col-11 justify-content-center align-items-start gap-3">
        <div className="col-lg-3 row m-0 p-0 gap-3">
          <div className="">
            <All_Participates
              data={{
                participates_count: `${allParticipants}`,
                active_participates_count: `${joined_last_24_hour}`,
              }}
            />
          </div>
          <div className="">
        ...
        <div className="col-lg-5 row m-0 gy-3 p-0 pt">
          <Id_Number
            data={{
              id: `${pack}`,
        ...
        <div className="col-lg-5 mb-5 mt-4">
          <Profit
            data={{
              earned: `${earnAmount || "0"}`,
              earned_outof: `${joinhere * 3}`,
              maxIncome: `${MaxIncome || "0"}`,
              EarnAmount: nettokenUsdvalue,
            }}
            opt={profit}
          />
        </div>
