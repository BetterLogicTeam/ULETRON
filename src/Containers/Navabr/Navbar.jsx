            ...
            <div className='col-md-11'>
                <nav class="navbar navbar-expand-lg navbar-light row d-flex flex-column">
                    <div className='row justify-content-between brand-bar'>
                        <img src={Logo} className='navbar-brand col-lg-1 col-md-3 col-5' />
                    ...
                    <div class="collapse navbar-collapse row px-5 py-1" id="navbarNavDropdown">
                        <ul class="navbar-nav nav-display">
				    ...
				    <Link to="/dashboard/Activate" onClick={onClick_DNone}><a><BsArrowRightShort /> Activate</a></Link>
                                        <Link to="/dashboard/Activate_History" onClick={onClick_DNone}><a><BsArrowRightShort /> Activation History</a></Link>
                                        <Link to="/dashboard/Registration_history" onClick={onClick_DNone}><a><BsArrowRightShort /> Registration History</a></Link>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div className='expand-nav  d-none flex-column'>
                                        ...
                                        <Link onClick={onClick_DNone} to="/dashboard/Matching_Income"><BsArrowRightShort /> Matching Reward</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Matching_Level_Income"><BsArrowRightShort /> Referral Daily Yield</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Roi_Income"><BsArrowRightShort /> Daily Yield</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Dividend_income"><BsArrowRightShort /> Dividend Reward</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Rank_Yield_income"><BsArrowRightShort /> Rank Achievers Yield</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Registration_level_income"><BsArrowRightShort /> Referral Level Income</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Registration_direct_income"><BsArrowRightShort /> Registration Reward</Link>
                                        <Link onClick={onClick_DNone} to="/dashboard/Reward_Income"><BsArrowRightShort /> Referral Daily Yield Booster </Link>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <button className='btn1 nav-btn-expand fs-5'><BiBook className="me-1 mb-1 fs-4" /> Withdrawal</button>
                                    <div className='expand-nav  d-none flex-column'>
                            ...
                            <li style={{display:'none'}}>
                                <div>
                                    <button className='btn1 nav-btn-expand fs-5' > </button>
                                    <div className='expand-nav  d-none flex-column'>
                    ...
                    <div className='nav-panel d-none  col-10' id='nav-bg-balck'>
                        <ul class="row p-0 justify-content-center list-unstyled">
                            ...
                            <li class="col-xl-10 col-12 border_bottom" id='border_nav'>
                                <div>
                                    ...
                                    <div className='expand-nav-sm  d-none flex-column'>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Activate"><BsArrowRightShort /> Activate</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Activate_History"><BsArrowRightShort /> Activate History</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Registration_history"><BsArrowRightShort />  Registration History</Link>
                            ...
                            <li class="col-xl-10 col-12 border_bottom">
                                <div>
                                    ...
                                    <div className='expand-nav-sm  d-none flex-column'>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Referral_Income"><BsArrowRightShort />Matching Reward</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Matching_Level_Income"><BsArrowRightShort /> Referral Daily Yield</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Dividend_income"><BsArrowRightShort /> Dividend Reward</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Roi_Income"><BsArrowRightShort /> Daily Yield</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Rank_Yield_income"><BsArrowRightShort /> Rank Achievers Yield</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Registration_level_income"><BsArrowRightShort /> Referral Level Income</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Registration_direct_income"><BsArrowRightShort /> Registration Reward</Link>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/Reward_Income"><BsArrowRightShort /> Referral Daily Yield Booster</Link>
                                    </div>
                                </div>
                            </li>
                            <li class="col-xl-10 col-12 border_bottom">
                            ...
                            <li class="col-xl-10 col-12 border_bottom" style={{display:'none'}}>
                                <div>
                            ...
                            <li class="col-xl-10 col-12 border_bottom">
                                <div>
                                    ...
                                    <div className='expand-nav-sm  d-none flex-column'>
                                        <Link onClick={sm_nav_dnone} to="/dashboard/My_Referral"><BsArrowRightShort /> My Referal</Link>
